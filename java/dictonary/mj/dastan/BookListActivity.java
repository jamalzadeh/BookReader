...
import dictonary.mj.dastan.BookListFragment.OnItemSelectedListener;
/**
 ...
 */
public class BookListActivity extends FragmentActivity  implements OnItemSelectedListener {
...
/*	@Override
	...
	private void determinePaneLayout() {
		FrameLayout fragmentItemDetail = (FrameLayout) findViewById(R.id.book_detail_container);
		if (fragmentItemDetail != null) {
			mTwoPane = true;
			BookListFragment fragmentItemsList = 
	...
	public void onItemSelected(String id) {
		...
		/*	Log.v("two pane:",id);
			...
			BookDetailFragment fragmentItem = BookDetailFragment.newInstance(id);
			FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
			ft.replace(R.id.book_detail_container, fragmentItem);
			ft.commit();
