...
public class JpubInstaller extends Activity implements JpubTask.TaskCallbacks{
	private static final String TAG_TASK_FRAGMENT = "task_fragment";
	String path;
	public static String IM_PATH= "/data/data/dictonary.mj.dastan/images/" ;
		  private JpubTask mTaskFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jpub_installer);
	       ...
	       textv.setTypeface(type);
		    ...
		    mTaskFragment = (JpubTask) fm.findFragmentByTag(TAG_TASK_FRAGMENT);

		    // If the Fragment is non-null, then it is currently being
		    // retained across a configuration change.
		    if (mTaskFragment == null) {
		      mTaskFragment = new JpubTask();
		      Log.v("path",path);
	...
	public void onBackPressed() {
		...
		Toast.makeText(JpubInstaller.this, getResources().getString(R.string.no_back), Toast.LENGTH_SHORT).show();
	}
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		// Inflate the menu; this adds items to the action bar if it is present.
		getMenuInflater().inflate(R.menu.jpub_installer, menu);
		return true;
	}
